...
export default function Account() {
  ...
  return (
    <div className="max-w-4xl space-y-6 pb-8">
      {/* Header */}
      <h1 className="text-3xl font-black tracking-tight text-text-primary">Account</h1>

      {/* ── Profile section ─────────────────────────────────────────────────── */}
      <section className="space-y-0 divide-y divide-border-subtle">
        <h2 className="text-base font-bold text-text-primary pb-3">Profile</h2>
      ...
      {/* ── Security section ─────────────────────────────────────────────────── */}
      <section className="space-y-0 divide-y divide-border-subtle">
        <h2 className="text-base font-bold text-text-primary pb-3">Security</h2>
      ...
      {/* ── Sessions section ─────────────────────────────────────────────────── */}
      <section className="space-y-0 divide-y divide-border-subtle">
        <h2 className="text-base font-bold text-text-primary pb-3">Sessions</h2>
